...
func (u *useCase) ListModuleSelect() ([]ModuleSelectItem, error) {
	list, err := u.repo.ListModuleSelect()
	if err != nil {
		return nil, mechanic.InternalError("Failed to list module options", err)
	}
	return list, nil
}
